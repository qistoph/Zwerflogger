...
class Config {
	static function init() {
		...
		self::$secure_cookies = !empty($_SERVER['HTTPS']); // Only set true if using HTTPS
		...
		self::$pushover_app_token = ''; // See https://pushover.net
		self::$pushover_group_id = '';
	...
	static $time_format;
	static $pushover_app_token;
	static $pushover_group_id;
	static $QR_eclevel;
